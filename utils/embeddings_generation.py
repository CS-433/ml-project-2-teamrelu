...
create_protein_embeddings(sequences_path, output_embeddings_path, chunk_size=5, small_embedder=False, verbose=False)

# Create the file containing yORF and embeddings
create_extremities_embeddings(sequences_path, output_ext_embeddings_path, 20, small_embedder=False)