...
dynamic_model = DynamicModel(static_model, temporal_block, static_learnable=False, num_timesteps=num_timesteps, num_classes=num_classes)
...
if static_learnable == True:
    ...
    optimizer = torch.optim.AdamW(dynamic_model.parameters(), learning_rate, weight_decay=weight_decay)
# Define scheduler
dynamic_scheduler = CosineAnnealingLR(optimizer,T_max=(len(dataloader_train.dataset) * num_epochs) // batch_size)
